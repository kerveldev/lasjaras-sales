...
const METODOS = [
  {
    ...
    icons: ["/visa.png", "/mastercard.png", "/amex.png"], // Usa tus rutas locales o públicas
        ...
        {cliente && membresia ? (
            ...
            >
              ...
              <div className="mb-8 space-y-5">
                <div className="text-lg font-semibold mb-1">Selecciona un método de pago</div>
                {METODOS.map((m) => (
                    <label
                        key={m.key}
                        className={`
                    ...
                    >
                      ...
                      {m.icons.length > 0 && (
                          <div className="flex gap-3 items-center mb-3">
                            {m.icons.map((icon, i) => (
                                <Image src={icon} key={i} alt="" className="w-10 h-7   "  width={200}
                                       height={200}/>
                            ))}
                          </div>
                      )}
              ...
              <div className="bg-orange-50 border-l-4 border-orange-400 flex items-center gap-2 px-4 py-3 rounded text-orange-700 text-sm">
                ...
                Todas los pagos son procesados de forma segura. Tus datos están protegidos con encriptación de nivel bancario.
              </div>
            </>
        ) : (
